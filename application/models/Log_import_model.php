...
class Log_import_model extends CI_Model {
	...
	function uploadData($data)
    {
        ...
        $this->db->insert_batch('transactionlog', $data);
		...
		if ($this->db->trans_status() === FALSE)
		{
			...
			header( 'Location: '.base_url("index.php/Log_import") ) ;
	}
		else  {
    ...
    {
        $query = $this->db->get('transactionlog');
